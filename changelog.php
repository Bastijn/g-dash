<div class="row row-offcanvas row-offcanvas-left">
    ...
    <div class="col-sm-9 col-md-10 main">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <ul>
                    ...
                    <li>TEXTUAL: Show a warning message in the GuldenD settings screen these settings are for advanced
                        users.
                    </li>
                    <li>FEATURE: Added a GDCLI command for resetting the blockchain forcing a full resync. Usage: <code>php
                            /var/www/html/gdcli reset_blockchain</code></li>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <ul>
                    ...
                    <li>FEATURE: New 3D graph in witness network showing time, weight and amount locked for all witness
                        accounts.
                    </li>
                    <li>FEATURE: GitHub issue #11: Witness accounts transactions can be found underneath the earnings
                        graph.
                    </li>
                    ...
                    <li>BUG: Witness status (cooldown/initial funding) was incorrectly displayed when public key is not
                        used yet.
                    </li>
                    <li>ENHANCEMENT: Change OTP key to 16 chars as an iPhone is not always able to scan a 32 or 64 char
                        barcode.
                    </li>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <ul>
                    <li>IMPROVEMENT: Add G-DASH version on calls to remaining JS files to prevent browser caching on new
                        releases.
                    </li>
                </ul>
            </div>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <ul>
                    ...
                    <li>ENHANCEMENT: GitHub issue #9: Show command in Config Check page for making debug.log file
                        readable.
                    </li>
                    ...
                    <li>IMPROVEMENT: In the wallet TX list, when the blockchain API is down, stop trying to connect.
                    </li>
                    <li>IMPROVEMENT: Close the session before performing large requests in AJAX scripts, allowing
                        multiple pages to be opened.
                    </li>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <ul>
                    <li>NOTE: This is the last beta release before version 1. After this update the stable and beta
                        channel will be used as intended.
                    </li>
                    <li>NOTE: This is a small in between release to make life easier for users to upgrade to Gulden
                        2.0.
                    </li>
                    ...
                    <li>IMPROVEMENT: Show the Gulden message when upgrading database / blocks instead of custom
                        message.
                    </li>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <ul>
                    ...
                    <li>FEATURE: Added terminal commands 'walletunlock', 'rescan', and 'getrescanprogress'. Use 'help'
                        for details.
                    </li>
                    <li>FEATURE: Many more! Check <a
                                href='https://github.com/Bastijn/g-dash/commit/fb4d1f8a855179744d79fb91a6d6123f247006ea'
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <ul>
                    <li>BUG: Transaction list in wallet could not always use the raw data without TX indexing, created
                        failsafe to Insight API.
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <ul>
                    <li>ENHANCEMENT: Changed the layout of the settings page for easier access to specific settings.
                    </li>
                    <li>FEATURE: New option in settings to set a currency exchange to your liking used in the wallet to
                        calculate the current
                        value of NLG to other currencies (i.e. Nocks and GuldenTrader for Euro, CryptoCompare for USD,
                        BitTrex for BTC).
                    </li>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <ul>
                    ...
                    <li>FEATURE: Added a G-DASH CLI for password resets (inspired by ownclouds' occ). Usage: <code>php
                            /var/www/html/gdcli</code></li>
                    <li>ENHANCEMENT: GitHub issue #7: Turned of auto-complete for usernames and passwords in the
                        settings.
                    </li>
                </ul>
            </div>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <ul>
                    ...
                    <li>FEATURE: Removed restrictions for upload node statistics (now available even if there are no
                        inbound connections).
                    </li>
                    <li>FEATURE: Added a notification to the terminal if the debug.log file is not readable by the
                        webserver.
                    </li>
                    <li>FEATURE: Added a new command 'noderequest' to the terminal to request being added by other nodes
                        automatically (i.e. for zero inbound connections).
                    </li>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <ul>
                    <li>GitHub issue #5: A more secure hashing is used for passwords. Passwords are automatically
                        updated
                        after logging in.
                    </li>
                    <li>Removed deprecated RPC login function.</li>
                    <li>GitHub issue #3: Changed the link at the settings page to the new developer page at
                        Gulden.com.
                    </li>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <ul>
                    ...
                    <li>A push notification can be send when a new version of Gulden is available in the Raspbian
                        repository.
                    </li>
                    ...
                    <li>A notification is shown when there is an update of Gulden available in the Raspbian
                        repository.
                    </li>
            ...
            <div class="panel-body">
                <ul>
                    <li>Even more secure login: You can now choose a seperate username and password just for G-DASH. No
                        need to use the same username and password as for GuldenD (Gulden.conf) anymore.
                    </li>
                    ...
                    <li>Added port checker for node and witness to the Config Check page (hosted by guldennodes.com).
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <ul>
                    ...
                    <li>Send push messages to your phone, tablet, smartwatch and PC about the status of your G-DASH and
                        Gulden
                        server using PushBullet. You will have to create an access token yourself which you can
                        get at <a href="https://www.pushbullet.com/#settings/account" target="_blank">your account
                            page</a>.
                    </li>
                    <li>At this point the only push message is a check if the Gulden server is running. In the future
                        more options will be added like a push message for transactions or witness actions.
                    </li>
                    <li>A cron job will check for pushable updates every 5 minutes. Of course this won't work if your
                        machine
                        is powered off or offline.
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <ul>
                    ...
                    <li>If a wallet is not encrypted, it has to be encrypted before users can engage in any transactions
                        or see the "Recovery Phrase".
                    </li>
                    <li>A lock indicates if a wallet is locked (green, closed) or unlocked (red, open).</li>
                    <li>Show a new address after each transaction to the latest address (so address will not change if
                        the address is not used yet).
                    </li>
                    ...
                    <li>Import "Recovery Phrase" al set, but not activated at the moment as there is no easy way to run
                        the rescan flag.
                    </li>
                </ul>
            </div>
