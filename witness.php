...
<div class="row row-offcanvas row-offcanvas-left">
    ...
    <div class="col-sm-9 col-md-10 main">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="newaccountname">
                                <small>Account name (Normal letters only and no &#42; allowed)</small>
                            </label><br>
                            <input id="newaccountname" name="newaccountname" type="text" class="form-control">
                        </div>
                        <div class="form-group">
                            <label for="confirmwithdrawpass">
                                <small>Pass Phrase</small>
                            </label><br>
                            <input type="password" id="newaccountpassword" name="newaccountpassword" autocomplete='off'>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-success" id="creataccountbutton" onclick="addAccount()">
                            Create account
                        </button>
                    </div>
        ...
        <div id="fundwitnessaccount" class="modal fade" role="dialog">
            <div class="modal-dialog">
                <div class="modal-content" name="fundwitnessaccountmodal" id="fundwitnessaccountmodal">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="selectedwitnessaccount">
                                <small>Selected witness account</small>
                            </label><br>
                            <input id="selectedwitnessaccount" name="selectedwitnessaccount" type="text"
                                   class="form-control" readonly>
                        </div>
                        <div class="form-group">
                            <label for="selectedguldenaccount">
                                <small>From Gulden account</small>
                            </label><br>
                            <select name="selectedguldenaccount" id="selectedguldenaccount"></select>
                        </div>
                        <div class="form-group">
                            <label for="lockamount">
                                <small>Amount of Gulden to lock</small>
                            </label><br>
                            <input id="lockamount" name="lockamount" type="text" class="form-control bfh-number"
                                   data-min="5000" data-max="999999999">
                        </div>
                        <div class="form-group">
                            <label for="locktime">
                                <small>Time to lock Gulden (months)</small>
                            </label><br>
                            <div id="slider">
                                <div id="locktime" name="locktime" class="ui-slider-handle"></div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="lockweight">
                                <small>Your weight (minimum 10000; max 1%)</small>
                            </label><br>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-success" id="lockbutton" onclick="createWitnessDetails();">
                            Lock Gulden
                        </button>
                    </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content" name="fundingpopupmodal" id="fundingpopupmodal">
                    ...
                    <div class="modal-body">
                        ...
                        <p>
                            <label for="confirmwitnessaccount">
                                <small>Selected witness account</small>
                            </label><br>
                        <div id="confirmwitnessaccount"></div>
                        </p>
                        <p>
                            <label for="confirmguldenaccount">
                                <small>From Gulden account</small>
                            </label><br>
                        <div id="confirmguldenaccount"></div>
                        </p>
                        <p>
                            <label for="confirmamount">
                                <small>Amount of Gulden to lock</small>
                            </label><br>
                        ...
                        <p>
                            <label for="confirmtime">
                                <small>Time to lock</small>
                            </label><br>
                        <div id="confirmtime"></div>
                        </p>
                        <p>
                            <label for="confirmtransactionpass">
                                <small>Pass Phrase</small>
                            </label><br>
                        <div><input type="password" id="confirmtransactionpass" name="confirmtransactionpass"
                                    autocomplete='off'></div>
                        </p>
                        <div id="conftransmes" name="conftransmes"></div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger" id="confirmedcancel" name="confirmedcancel"
                                onclick="confirmWitnessDetails()">Cancel
                        </button>
                        <button type="button" class="btn btn-success" id="confirmedsubmit" name="confirmedsubmit"
                                onclick="confirmWitnessDetails('true')">Send
                        </button>
                    </div>
                </div>
            </div>
                ...
                <div class="modal-content" name="importwitnessaccountmodal" id="importwitnessaccountmodal">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-success" id="importbutton"
                                onclick="importWitnessAccount();">Import witness account
                        </button>
                    </div>
        ...
        <div id="withdrawwitnessaccount" class="modal fade" role="dialog">
            <div class="modal-dialog">
                <div class="modal-content" name="withdrawwitnessaccountmodal" id="withdrawwitnessaccountmodal">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="selectedwitnessaccountwithdraw">
                                <small>Selected witness account</small>
                            </label><br>
                            <input id="selectedwitnessaccountwithdraw" name="selectedwitnessaccountwithdraw" type="text"
                                   class="form-control" readonly>
                        </div>
                        <div class="form-group">
                            <label for="guldenaddresswithdraw">
                                <small>Send to Gulden address</small>
                            </label><br>
                            <input id="guldenaddresswithdraw" name="guldenaddresswithdraw" type="text"
                                   class="form-control">
                        </div>
                        <div class="form-group">
                            <label for="confirmwithdrawpass">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-success" id="witnesswithdrawbutton"
                                onclick="withdrawWitnessEarnings();">Withdraw witness earnings
                        </button>
                    </div>
        ...
        <div id="exportwitnesskey" class="modal fade" role="dialog">
            <div class="modal-dialog">
                <div class="modal-content" name="exportwitnesskeymodal" id="exportwitnesskeymodal">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="selectedwitnessaccountkey">
                                <small>Selected witness account</small>
                            </label><br>
                            <input id="selectedwitnessaccountkey" name="selectedwitnessaccountkey" type="text"
                                   class="form-control" readonly>
                        </div>
                        <div class="form-group">
                            <label for="rppass">
                                <small>Unlock your wallet with your password</small>
                            </label><br>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-success" onclick="showWitnessKey();">Show witness key
                        </button>
                    </div>
                ...
                <div class="modal-content" name="renameaccountmodal" id="renameaccountmodal">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-success" data-dismiss="modal"
                                onclick="renameWitnessAccount()">Rename account
                        </button>
                    </div>
        ...
        <div id="deleteaccount" class="modal fade" role="dialog">
            <div class="modal-dialog">
                <div class="modal-content" name="deleteaccountmodal" id="deleteaccountmodal">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="selectedwitnessaccountdelete">
                                <small>Selected witness account</small>
                            </label><br>
                            <input id="selectedwitnessaccountdelete" name="selectedwitnessaccountdelete" type="text"
                                   class="form-control" readonly>
                        </div>

                        Are you sure you want to delete this account? By pressing "yes" this account will be removed
                        from every overview.
                        <br><br>
                        <div class="form-group">
                            <label for="delpass">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger" id="confirmdelcancel" name="confirmdelcancel"
                                onclick="confirmDeleteAccount()">Cancel
                        </button>
                        <button type="button" class="btn btn-danger" id="confirmdelsubmit" name="confirmdelsubmit"
                                onclick="confirmDeleteAccount('true')">Yes
                        </button>
                    </div>
                </div>
            </div>
        ...
        <div id="withdrawfundingwitnessaccount" class="modal fade" role="dialog">
            <div class="modal-dialog">
                <div class="modal-content" name="withdrawfundingwitnessaccountmodal"
                     id="withdrawfundingwitnessaccountmodal">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="wifselectedwitnessaccount">
                                <small>Selected witness account</small>
                            </label><br>
                            <input id="wifselectedwitnessaccount" name="wifselectedwitnessaccount" type="text"
                                   class="form-control" readonly>
                        </div>
                        <div class="form-group">
                            <label for="wifselectedguldenaccount">
                                <small>To Gulden account</small>
                            </label><br>
                            <select name="wifselectedguldenaccount" id="wifselectedguldenaccount"></select>
                        </div>
                        <div class="form-group">
                            <label for="wifwalletpass">
                                <small>Wallet password</small>
                            </label><br>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-success" id="wifbutton" onclick="withdrawWitnessFunds();">
                            Withdraw initial funding
                        </button>
                    </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div id="witnesstxlist" name="witnesstxlist">
                            <table class="table table-striped" id="tabletransactions">
                                ...
                                <tbody>
                                <tr>
                                    <td colspan="2"><img src='images/loading.gif' border='0' height='64' width='64'>
                                        Loading....
                                    </td>
                                </tr>
                                </tbody>
