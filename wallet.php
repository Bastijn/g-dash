            ...
            <div class="modal-dialog">
                <div class="modal-content" name="newaccountmodal" id="newaccountmodal">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal" onclick="addAccount()">Create
                            account
                        </button>
                    </div>
        ...
        <div id="renameaccount" class="modal fade" role="dialog">
            <div class="modal-dialog">
                <div class="modal-content" name="renameaccountmodal" id="renameaccountmodal">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal" onclick="renameAccount()">
                            Rename account
                        </button>
                    </div>
        ...
        <div id="importrecoveryphrase" class="modal fade" role="dialog">
            <div class="modal-dialog">
                <div class="modal-content" name="importrecoveryphrasemodal" id="importrecoveryphrasemodal">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="therecphrase">
                                <small>Recovery Phrase</small>
                            </label><br>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" onclick="impRecovery();">Import Recovery Phrase
                        </button>
                    </div>
        ...
        <div id="showrecoveryphrase" class="modal fade" role="dialog">
            <div class="modal-dialog">
                <div class="modal-content" name="recoveryphrasemodal" id="recoveryphrasemodal">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" onclick="showRecoveryPhrase();">Show Recovery
                            Phrase
                        </button>
                    </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content" name="setuppassphrasemodal" id="setuppassphrasemodal">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="rpnewpass">
                                <small>Normal letters only and no &#42; allowed</small>
                            </label><br>
                            <input id="rpnewpass" name="rpnewpass" type="password" class="form-control"
                                   autocomplete='off'>
                        </div>
                        <div class="form-group">
                            <label for="rpnewpasstwo">
            ...
            <div class="modal-dialog">
                <div class="modal-content" name="changepassphrasemodal" id="changepassphrasemodal">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="changedrpnewpass">
                                <small>New password (normal letters only and no &#42; allowed)</small>
                            </label><br>
                            <input id="changedrpnewpass" name="changedrpnewpass" type="password" class="form-control"
                                   autocomplete='off'>
                        </div>
                        <div class="form-group">
                            <label for="changedrpnewpasstwo">
                                <small>Repeat password</small>
                            </label><br>
                            <input id="changedrpnewpasstwo" name="changedrpnewpasstwo" type="password"
                                   class="form-control" autocomplete='off'>
                        </div>
                        <div id="changepasserror" name="changepasserror"></div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" onclick="changePassPhrase();">Change password
                        </button>
                    </div>
        ...
        <div id="createtransaction" class="modal fade" role="dialog">
            <div class="modal-dialog">
                <div class="modal-content" name="createtransactionmodal" id="createtransactionmodal">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="transactionaddress">
                                <small>Gulden receiving address</small>
                            </label><br>
                            <input id="transactionaddress" name="transactionaddress" type="text" class="form-control">
                        </div>
                        <div class="form-group">
                            <label for="transactionamount">
                                <small>Amount of Gulden to send</small>
                            </label><br>
                            <input id="transactionamount" name="transactionamount" type="text"
                                   class="form-control bfh-number" data-min="1" data-max="999999">
                        </div>
                        <div id="transactionmessage" name="transactionmessage"></div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" onclick="createTransactionDetails();">Send
                        </button>
                    </div>
        ...
        <div id="transactionpopup" class="modal fade" role="dialog">
            <div class="modal-dialog">
                <div class="modal-content" name="transactionpopupmodal" id="transactionpopupmodal">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" onclick="confirmTransactionDetails()">Cancel
                        </button>
                        <button type="button" class="btn btn-default" id="confirmedsubmit" name="confirmedsubmit"
                                onclick="confirmTransactionDetails('true')">Send
                        </button>
                    </div>
                </div>
            </div>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body" id="accountactions">
                        <div id="unencryptedwallet" name="unencryptedwallet" style="display: none;">
                            ...
                            This is a new wallet. To recover another wallet, import your wallet using the Recovery
                            Phrase.<br>
                            <ul>
                                <li><a data-toggle="modal" href="#importrecoveryphrase">Import existing Recovery
                                        Phrase</a></li>
                            </ul>
                            Your wallet is not encrypted. No transactions can be made until you encrypt your wallet.
                            <ul>
                                <li><a data-toggle="modal" href="#setuppassphrase">Set a password to encrypt this
                                        wallet</a></li>
                            </ul>
                        </div>
                    ...
                    <div class="panel-body" id="accounttransactions">
                        <div class="table-responsive">
                            <table class="table table-striped" id="tabletransactions">
                                ...
                                <tbody>
                                <tr>
                                    <td colspan="3"><img src='images/loading.gif' border='0' height='64' width='64'>
                                        Loading....
                                    </td>
                                </tr>
                                </tbody>
