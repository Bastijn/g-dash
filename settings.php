...
<div class="row row-offcanvas row-offcanvas-left">
    ...
    <div class="col-sm-9 col-md-10 main">
        ...
        if (isset($_POST['weblocation'])) {
            ...
            if ($_POST['allownoderequests'] == "") {
                $CONFIG['allownoderequests'] = "0";
            } else {
                $CONFIG['allownoderequests'] = "1";
            }

            $CONFIG['pushbullet'] = $_POST['pushbullet'];
            $CONFIG['pushbulletgulden']['active'] = $_POST['pushbulletgulden'];
            if ($CONFIG['pushbulletgulden']['lastmes'] == "") {
                $CONFIG['pushbulletgulden']['lastmes'] = "";
            }
            $CONFIG['pushbulletgdash']['active'] = $_POST['pushbulletgdash'];
            if ($CONFIG['pushbulletgdash']['lastmes'] == "") {
                $CONFIG['pushbulletgdash']['lastmes'] = "";
            }
            $CONFIG['pushbullettx']['active'] = $_POST['pushbullettx'];
            if ($CONFIG['pushbullettx']['lastmes'] == "") {
                $CONFIG['pushbullettx']['lastmes'] = "";
            }
            $CONFIG['pushbulletguldenupdate']['active'] = $_POST['pushbulletguldenupdate'];
            if ($CONFIG['pushbulletguldenupdate']['lastmes'] == "") {
                $CONFIG['pushbulletguldenupdate']['lastmes'] = "";
            }
            $CONFIG['pushbulletwitness']['active'] = $_POST['pushbulletwitness'];
            if ($CONFIG['pushbulletwitness']['lastmes'] == "") {
                $CONFIG['pushbulletwitness']['lastmes'] = "";
            }
            if ($CONFIG['pushbulletwitness']['lastblock'] == "") {
                $CONFIG['pushbulletwitness']['lastblock'] = "";
            }
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <p>If you have not disabled the login screen, you will be automatically logged out when
                                clicking OK.
                                You have to log in with your new username and password. Note that Two Factor
                                Authentication
                                has been disabled as you changed your password. You can safely turn this back on when
                                you
                                are logged in again.</p>
                        </div>
                        <div class="modal-footer">
                            <button type="button" id="changedpass" class="btn btn-default" data-dismiss="modal">OK
                            </button>
                        </div>
                    </div>
                ...
                <div class="tab-content">
                    <div id="gdashsettings" class="tab-pane fade in active">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body" id="dashboardsettings">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="gdashuser" name="gdashuser"
                                           autocomplete='off'
                                           placeholder="Username" <?php if ($CONFIG['gdashuser'] != '') {
                                        echo "value='" . $CONFIG['gdashuser'] . "'";
                                    } ?>>
                                </div>

                                <div class="form-group">
                                    <label for="gdashpassword">G-DASH password</label>
                                    <input type="password" class="form-control" id="gdashpassword" name="gdashpassword"
                                           placeholder="Password" autocomplete='off'>
                                </div>

                                <div class="form-group">
                                    <label for="gdashpasswordrepeat">Repeat G-DASH password</label>
                                    <input type="password" class="form-control" id="gdashpasswordrepeat"
                                           name="gdashpasswordrepeat" aria-describedby="gdashpasswordrepeathelp"
                                           placeholder="Password" autocomplete='off'>
                                    <small id="gdashpasswordrepeathelp" class="form-text text-muted">Choose a strong
                                        password!! Minimum of 8 characters, 1 uppercase letter and 1 number.
                                    </small>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="weblocation" name="weblocation"
                                           aria-describedby="weblocationhelp"
                                           placeholder="Enter web address" <?php if ($CONFIG['weblocation'] != '') {
                                        echo "value='" . $CONFIG['weblocation'] . "'";
                                    } ?>>
                                    <small id="weblocationhelp" class="form-text text-muted">For example:
                                        http://192.168.2.1/gulden/
                                    </small>
                                </div>

                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" id="disablelogin" name="disablelogin"
                                               aria-describedby="disableloginhelp"
                                               value="1" <?php if ($CONFIG['disablelogin'] == "1") {
                                            echo "checked='checked'";
                                        } ?>>Disable login screen</label><br>
                                    <small id="disableloginhelp" class="form-text text-muted">Note: By disabling the
                                        login screen, everyone on your network (or if your server can be reached
                                        from the internet --> EVERYONE) can access this dashboard
                                    </small>
                                </div>

                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" id="updatechannel" name="updatechannel"
                                               aria-describedby="updatechannelhelp"
                                               value="1" <?php if ($CONFIG['updatechannel'] == "1") {
                                            echo "checked='checked'";
                                        } ?>>Use the Beta update channel</label><br>
                                    <small id="updatechannelhelp" class="form-text text-muted">The Beta updates may
                                        contain bugs. Use this option only if you want to help testing!
                                    </small>
                                </div>
                                ...
                                <?php if ($CONFIG['disablelogin'] != "1") {
                                    ...
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" id="otp" name="otp" aria-describedby="otphelp"
                                                   value="1" <?php if ($CONFIG['otp'] == "1") {
                                                echo "checked='checked'";
                                            } ?>>Use 2-factor authentication</label><br>
                                        <small id="otphelp" class="form-text text-muted">With 2-factor authentication
                                            your dashboard is better protected as you will need your smartphone to log
                                            in.<br>
                                            Note: You will not be able to log in without your smartphone. If you lost
                                            your phone (or broke it), you will have
                                            to manually remove 2FA from the G-DASH settings file (OTP).
                                        </small>
                                    </div>
		    		  ...
		    		  or <a href='https://itunes.apple.com/us/app/google-authenticator/id388497605?mt=8' target='_blank'>for iOS</a>)<br>";
                                    ...
                                    print sprintf('<img src="%s"/>',
                                        TokenAuth6238::getBarCodeUrl('', $currentDomain, $otpkey, 'G-DASH'));
                                }
                                ?>
                            </div>
                        </div>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body" id="notifications">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="pushbullet" name="pushbullet"
                                           aria-describedby="pushbullethelp"
                                           placeholder="Enter access token" <?php if ($CONFIG['pushbullet'] != '') {
                                        echo "value='" . $CONFIG['pushbullet'] . "'";
                                    } ?>>
                                    <small id="pushbullethelp" class="form-text text-muted">Using PushBullet (free), you
                                        can send notifications to your phone, tablet, smartwatch and computer when one
                                        of the actions below
                                        are triggered. Check <a href='https://www.pushbullet.com' target='_blank'>pushbullet.com</a>
                                        for more details
                                        and to set up an account. If you have an account, you can create an access token
                                        in the
                                        <a href='https://www.pushbullet.com/#settings/account' target='_blank'>account
                                            settings page</a>
                                        to monitor G-DASH. Clear the access token field to stop receiving updates or
                                        un-check all items below.
                                ...
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" id="pushbulletgulden" name="pushbulletgulden"
                                               aria-describedby="pushbulletguldenhelp"
                                               value="1" <?php if ($CONFIG['pushbulletgulden']['active'] == "1") {
                                            echo "checked='checked'";
                                        } ?>>Send a notification if the Gulden server is down.</label><br>
                                    <small id="pushbulletguldenhelp" class="form-text text-muted">A notification will be
                                        sent to pushbullet if the Gulden server is not responding.<br>
                                ...
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" id="pushbulletgdash" name="pushbulletgdash"
                                               aria-describedby="pushbulletgdashhelp"
                                               value="1" <?php if ($CONFIG['pushbulletgdash']['active'] == "1") {
                                            echo "checked='checked'";
                                        } ?>>Send a notification if an update of G-DASH is available.</label><br>
                                    <small id="pushbulletgdashhelp" class="form-text text-muted">A notification will be
                                        sent to pushbullet if an update is available for G-DASH.<br>
                                ...
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" id="pushbulletguldenupdate" name="pushbulletguldenupdate"
                                               aria-describedby="pushbulletguldenupdatehelp"
                                               value="1" <?php if ($CONFIG['pushbulletguldenupdate']['active'] == "1") {
                                            echo "checked='checked'";
                                        } ?>>Send a notification when there is an update for Gulden.</label><br>
                                    <small id="pushbulletguldenupdatehelp" class="form-text text-muted">A notification
                                        will be sent to pushbullet when an update for Gulden is available in the
                                        Raspbian repository.<br>
                                ...
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" id="pushbullettx" name="pushbullettx"
                                               aria-describedby="pushbullettxhelp"
                                               value="1" <?php if ($CONFIG['pushbullettx']['active'] == "1") {
                                            echo "checked='checked'";
                                        } ?>>Send a notification when Guldens are received.</label><br>
                                    <small id="pushbullettxhelp" class="form-text text-muted">A notification will be
                                        sent to pushbullet when you receive Guldens in your wallet.<br>
                                ...
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" id="pushbulletwitness" name="pushbulletwitness"
                                               aria-describedby="pushbulletwitnesshelp"
                                               value="1" <?php if ($CONFIG['pushbulletwitness']['active'] == "1") {
                                            echo "checked='checked'";
                                        } ?>>Send a notification on witness activity.</label><br>
                                    <small id="pushbullettxhelp" class="form-text text-muted">A notification will be
                                        sent to pushbullet when there was any activity with your witness account.<br>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body" id="nodesettings">
                                <div id='nodeuploaddiv' class="checkbox">
                                    <label>
                                        <input type="checkbox" id="nodeupload" name="nodeupload"
                                               aria-describedby="nodeuploadhelp"
                                               value="1" <?php if ($CONFIG['nodeupload'] == "1") {
                                            echo "checked='checked'";
                                        } ?>>Upload node statistics</label><br>
                                    <small id="nodeuploadhelp" class="form-text text-muted">Help the Gulden network by
                                        uploading your node statistics. You can see the stats
                                        of your node and a spider web showing all your connections on
                                        <a href="https://guldennodes.com/?crawler" target="_blank">
                                            https://guldennodes.com/?crawler</a><br>(Note: This link only works if you
                                        visit
                                        this website from the same network as your node. Otherwise, use
                                        "?crawler=YourIP")
                                    </small>
                                </div>
                                ...
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" id="allownoderequests" name="allownoderequests"
                                               aria-describedby="allownoderequestshelp"
                                               value="1" <?php if ($CONFIG['allownoderequests'] == "1") {
                                            echo "checked='checked'";
                                        } ?>>Allow Node Requests</label><br>
                                    <small id="allownoderequestshelp" class="form-text text-muted">Help the Gulden
                                        network by temporarily (24 hours) connecting to a G-DASH node that requested
                                        inbound connections. You will only connect to 1 node from the list and it will
                                        automatically
                                        be removed after 24 hours and the next node in line will be added for the next
                                        24 hours. This
                                        method allows G-DASH users without any inbound connections or a changed IP
                                        address to be found
                                        by others in the Gulden network.
                                    </small>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="walletsettings" class="tab-pane fade">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body" id="walletsettings">
                                ...
                                if ($currentnlgprovider == "") {
                                    $currentnlgprovider = 0;
                                }
                                ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <br>
                                    <small id="nlgpricehelp" class="form-text text-muted">The provider from where the
                                        NLG/CURRENCY conversion rate should be fetched.
                                    </small>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="guldensettings" class="tab-pane fade">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body" id="guldensettings">
                                <div><p class="text-danger">Do not change any of these settings if you don't know what
                                        you are doing! Please read the manual first.<br>
                                        By changing these settings incorrectly G-DASH might not be able to communicate
                                        with GuldenD.</p>
                                </div>
                                <div class="form-group">
                                    <label for="glocation">GuldenD location</label>
                                    <input type="text" class="form-control" id="glocation" name="glocation"
                                           aria-describedby="glocationhelp"
                                           placeholder="Enter path to GuldenD" <?php if ($CONFIG['guldenlocation'] != '') {
                                        echo "value='" . $CONFIG['guldenlocation'] . "'";
                                    } ?>>
                                    <small id="glocationhelp" class="form-text text-muted">The folder containing the
                                        GuldenD. For example: /opt/Gulden/Gulden-1.6.4/
                                    </small>
                                </div>
                                <div class="form-group">
                                    <label for="datalocation">Data location</label>
                                    <input type="text" class="form-control" id="datalocation" name="datalocation"
                                           aria-describedby="datalocationhelp"
                                           placeholder="Enter path to Gulden.conf" <?php if ($CONFIG['datadir'] != '') {
                                        echo "value='" . $CONFIG['datadir'] . "'";
                                    } ?>>
                                    <small id="datalocationhelp" class="form-text text-muted">The folder containing
                                        Gulden.conf. For example: /opt/Gulden/datadir/
                                    </small>
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="rpcuser" name="rpcuser"
                                           ...
                                           autocomplete='off' <?php if ($CONFIG['rpcuser'] != '') {
                                        echo "value='" . $CONFIG['rpcuser'] . "'";
                                    } ?>>
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control" id="rpcpassword" name="rpcpassword"
                                           ...
                                           autocomplete='off' <?php if ($CONFIG['rpcpass'] != '') {
                                        echo "value='" . $CONFIG['rpcpass'] . "'";
                                    } ?>>
                                    <small id="rpcpasswordrepeathelp" class="form-text text-muted">Note: The username
                                        and password must match the username and password used in the Gulden.conf file
                                    </small>
                                </div>
                                <div class="form-group">
                                    <label for="rpchost">Host address</label>
                                    <input type="text" class="form-control" id="rpchost" name="rpchost"
                                           aria-describedby="rpchosthelp"
                                           placeholder="RPC Host" <?php if ($CONFIG['rpchost'] != '') {
                                        echo "value='" . $CONFIG['rpchost'] . "'";
                                    } ?>>
                                    <small id="rpchosthelp" class="form-text text-muted">The RPC host address of the
                                        GuldenD. Default: 127.0.0.1
                                    </small>
                                </div>
                                <div class="form-group">
                                    <label for="rpcport">Host port</label>
                                    <input type="text" class="form-control" id="rpcport" name="rpcport"
                                           aria-describedby="rpcporthelp"
                                           placeholder="RPC Port" <?php if ($CONFIG['rpcport'] != '') {
                                        echo "value='" . $CONFIG['rpcport'] . "'";
                                    } ?>>
                                    <small id="rpcporthelp" class="form-text text-muted">The RPC port number of GuldenD.
                                        Default: 9232
                                    </small>
                                </div>
