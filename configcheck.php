        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body" id="guldenconf">
                ...
                if ($guldenconfperms['exists']) {
                    ...
                    if ($guldenconfperms['readable']) {
                        echo "<font color='green'>Gulden.conf is readable</font>";
                    } else {
                        echo "<font color='red'>Gulden.conf is not readable</font>";
                    }
                } else {
                ...
                if ($guldendperms['exists']) {
                    ...
                    if ($guldendperms['executable']) {
                        echo "<font color='green'>GuldenD is executable</font>";
                    } else {
                        echo "<font color='red'>GuldenD is not executable</font>";
                    }
                } else {
                ...
                if ($guldencliperms['exists']) {
                    ...
                    if ($guldencliperms['executable']) {
                        echo "<font color='green'>Gulden-cli is executable</font>";
                    } else {
                        echo "<font color='red'>Gulden-cli is not executable</font>";
                    }
                } else {
                ...
                if ($guldenlogperms['exists']) {
                    ...
                    echo "The file size of debug.log is \"" . round(filesize($CONFIG['datadir'] . "debug.log") / pow(1024,
                                2), 2) . "\" MB <br>";
